...
public class GroupedSearchResultRow extends SearchResultRow {
	...
	public GroupedSearchResultRow(String groupFieldName, String groupFieldValue, String fieldName, String fieldValue,
			String metricName) {
	...
	public String toString() {
		return "GroupedSearchResult [" + "fieldName=" + fieldName + ", fieldValue=" + fieldValue + ", groupFieldName="
				+ groupFieldName + ", groupFieldValue=" + groupFieldValue + ", metricName=" + metricName + "]";
	}
