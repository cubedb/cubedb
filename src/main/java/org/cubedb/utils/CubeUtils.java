...
public class CubeUtils {
	...
	/**
	 * Split array into n sublists fairly. Difference from Lists.partition is
	 * that: 1. We don't specify the size of each sublist. We specify the number
	 * of sublists. 2. Elements are distributed maximally equally.
	 * 
	 * @param in
	 * @param numParts
	 * @return
	...
	public static Map<String, Map<String, Map<String, Long>>> searchResultsToMap(Map<SearchResultRow, Long> in) {
		return in
		.entrySet()
		.stream()
		.collect(
